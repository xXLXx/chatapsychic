<?php
	...
	class faqs extends CI_Controller
	{
		...
		function index()
		{
			...
			$getQuestions = $this->db->query("SELECT * FROM faqs WHERE type = 'Applicants' ORDER BY sort ");
			$t['applicants'] = $getQuestions->result_array();
			
			$getQuestions = $this->db->query("SELECT * FROM faqs WHERE type = 'Affiliates' ORDER BY sort ");
			$t['affiliates'] = $getQuestions->result_array();
