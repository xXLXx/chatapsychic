        ...
        <div id='navbar' class="navbar navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <ul id='chatMenu' class="nav pull-right">
                        ...
                        <li class="dropdown chat_option">
                            ...
                            <ul id='settingsDropDownMenu' class="dropdown-menu">
                                <? if ($member_type == 'client') { ?>
                                    ...
                                    <li><a href="/contact" target="_blank" class='contactAdmin'>Contact Admin</a></li>
                                ...
                                <? } else { ?>
                                    <li><a href="#" class='pauseChatAnchor' style='display:block;'>Pause Timer</a></li>
                                    <li><a href="#" class='resumeChatAnchor' style='display:none;'>Resume Timer</a></li>
                                    ...
                                    <li><a href="#" class='addFreeTime' style='display:block;'>Add FREE Time</a></li>
                        ...
                        <li class="divider-vertical"></li>
                        <li class="chat_end"><a href="#" class='endChatAnchor' style='display:block;'>End Session</a></li>
                    </ul>
            ...
            <div style="display:none;" id="addStoredTime">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div style="float:left">
                            <a id="purchaseMoreTimeLink" href="/chat/main/purchase_time/<?=$reader['username'] ?>" target="_blank">
            ...
            <div id="addFreeTimeSection" style="display:none; margin-left:5px;">
                <div style="width:700px; margin-top:5px;">
                    ...
                    <div style="clear:both"></div>
                    <div>
                        <span style="vertical-align: top; font-size:11px;">ADD </span><input type="text" id="freeTimeInput"  style="border:1px #999 solid; color:#f6931f; font-weight:bold; width:50px; padding-top:2px; height:14px;"> 
                    </div>
                </div>
                <div style="clear:both"></div>
                <div>
