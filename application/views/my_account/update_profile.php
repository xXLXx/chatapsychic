	...
	<div class='content_area'>
		...
		<form action='/register/expert_submit' method='POST' enctype="multipart/form-data">
			...
			<table width='100%' cellPadding='10' cellSpacing='0'>
				...
				<tr>
					...
					<td><input type='text' name='username' value='<?=set_value('username', $this->member->data['username'])?>'></td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<img src='<?=$this->member->data['profile']?>' width='100' style='border:solid 1px #000;'>
				...
				<tr>
					<td style='width:150px;'><b>PayPal Email:</b> <span style='color:red;'>*</span></td>
					<td><input type='text' name='paypal' value='<?=set_value('paypal', $this->member->data['paypal'])?>'><div style='font-size:10px;'>So we can send you your payments</div></td>
				</tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td><a href='/' class='blue-button submit'><span>Save Profile</span></a></td>
				</tr>
