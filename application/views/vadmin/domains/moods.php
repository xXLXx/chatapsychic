...
<div style="padding:20px;background:#FFF;margin:20px;">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="/vadmin/domain_management/moods">Moods</a></li>
    </ul>

    <div class="tab-content">
        <div class="tab-pane active" id="products">
            <button class="btn btn-primary pull-right" style="margin-bottom: 5px;" type="button" id="btn-new"><i class="icon-upload"></i> Add New Mood</button>
            <table class="table table-bordered" id="table">
                ...
                <tbody>
                    <?php foreach ($moods as $mood): ?>
                        <tr>
                            <td><?= $mood["name"]; ?></td>
                            <td><?= $mood["descriptions"]; ?></td>
                            <td style="width: 5%;white-space: nowrap">
                                <a href="javascript:void(0)" class="btn-edit" data-id="<?=$mood["id"];?>">Edit</a>&nbsp;
                                <a href="javascript:void(0)" class="btn-delete" data-id="<?=$mood["id"];?>">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
...
<!-- Modal:Upload box -->
<div class="md-modal colored-header custom-width md-effect-9" id="mood-dlg" style="width: 70%; z-index: 1040">
    <div class="md-content">
        <div class="modal-header">
            <h3><span id="dlg-title">New</span> Mood</h3>
            <button type="button" class="close md-close" data-dismiss="modal" aria-hidden="true">×</button>
        </div>
        <div class="modal-body form">
            <div id="contents">
...
<script>
    $(document).ready(function () {
        ...
        $(".btn-delete").click(function(){
            $("#btn-delete").prop("href", "/vadmin/domain_management/delete_mood?id="+$(this).data("id"));
        ...
        $("#btn-save").click(function () {
            ...
            $.ajax({
                url: "/vadmin/domain_management/save_mood",
